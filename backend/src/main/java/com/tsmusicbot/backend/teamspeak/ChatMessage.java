 ...
 * @param targetMode whether this was a server, channel, or private message
 */
public record ChatMessage(
    String senderName, String senderUniqueId, String text, TextMessageTargetMode targetMode) {}
